...
const App = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:3000/list-items')
    ...
    const handleSubmit = async e => {
        ...
        if (listItem.todo === '') {
            ...
            await axios.post('http://localhost:3000/list-items', listItem);
    ...
    const handleDelete = async e => {
        ...
        await axios.delete(`http://localhost:3000/list-items/${deleItemId}`);
